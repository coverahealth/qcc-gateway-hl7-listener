# Graph Report - qcc-gateway-hl7-listener  (2026-08-28)

## Corpus Check
- 18 files · ~18,255 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 128 nodes · 139 edges · 13 communities (11 shown, 2 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `51c5592f`
...
Cohesion: 0.10
Nodes (20): Adding Dependencies, Create the stream and consumer, Creating the docker image, Development, Docker, Env Vars, Environment variables, Graphify Knowledge Graph (+12 more)
...
Cohesion: 0.13
Nodes (11): NATSMessager, Connect to the NATS jetstream server., Synchronously (no callback or async ACK) send the input message to the NATS, _process_hl7_text(), Verify each HL7 message gets its own unique correlation_id., test_correlation_id_unique_per_message(), test_nc_connect(), test_pilot() (+3 more)
...
- **Why does `qcc-gateway-hl7-listener` connect `Community 1` to `Community 5`?**
